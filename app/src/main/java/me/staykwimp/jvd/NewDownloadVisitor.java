...
public class NewDownloadVisitor implements BaseVisitor<Void> {
    private final int defaultItag;
    private final String saveDirectory;
    private final BiFunction<Integer, YoutubeVideoDownloader, Integer> onInvalidItag;


    public NewDownloadVisitor(int defaultItag, String saveDirectory, BiFunction<Integer, YoutubeVideoDownloader, Integer> onInvalidItag) {
